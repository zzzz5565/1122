...
import com.huitong.common.exception.job.TaskException;
...
import com.huitong.quartz.util.CronUtils;
import com.huitong.quartz.util.ScheduleUtils;
...
public class SysJobController extends BaseController
{
    ...
    @Decrypt
    @Encrypt
    public TableDataInfo list(@RequestBody SysJob job)
    {
        startPage(job.getPageNum(),job.getPageSize());
    ...
    @ResponseBody
    @Decrypt
    public AjaxResult export(@RequestBody SysJob job)
    {
        List<SysJob> list = jobService.selectJobList(job);
    ...
    @ResponseBody
    @Decrypt
    public AjaxResult remove(@RequestBody String ids) throws SchedulerException
    {
    ...
    @ResponseBody
    @Decrypt
    public AjaxResult addSave(@RequestBody @Validated SysJob job) throws SchedulerException, TaskException
    {
    ...
    @ResponseBody
    @Decrypt
    public AjaxResult editSave(@RequestBody @Validated SysJob job) throws SchedulerException, TaskException
    {
        if (!CronUtils.isValid(job.getCronExpression()))
        {
