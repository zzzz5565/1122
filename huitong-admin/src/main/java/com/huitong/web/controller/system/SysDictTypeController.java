...
public class SysDictTypeController extends BaseController
{
    ...
    {
        startPage(dictType.getPageNum(),dictType.getPageSize());
    ...
    @ResponseBody
    @Decrypt // 前端加密提交
    public AjaxResult addSave(@RequestBody @Validated SysDictType dict)
    {
    ...
    @ResponseBody
    @Decrypt
    public AjaxResult editSave(@RequestBody @Validated SysDictType dict)
    {
        if (UserConstants.DICT_TYPE_NOT_UNIQUE.equals(dictTypeService.checkDictTypeUnique(dict)))
        {
