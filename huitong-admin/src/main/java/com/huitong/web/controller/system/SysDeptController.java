...
public class SysDeptController extends BaseController
{
    ...
    @Decrypt
    @Encrypt
    public List<SysDept> list(@RequestBody(required = false) SysDept dept)
    {
    ...
    @ResponseBody
    @Decrypt
    public AjaxResult addSave(@RequestBody @Validated SysDept dept)
    {
    ...
    @ResponseBody
    @Decrypt
    public AjaxResult editSave(@RequestBody @Validated SysDept dept)
    {
