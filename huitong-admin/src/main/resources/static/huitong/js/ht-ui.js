    ...
    $.extend({
        ...
        table: {
            ...
            queryParams: function(params) {
                ...
                let otherparams = $.common.formToJSON(currentId);
                let newparams = $.extend(curParams,otherparams);
                let ciphertext = encrypt1(newparams);
                return ciphertext;
            },
            noEncryptQueryParams: function(params) {
                table.set();
                var curParams = {
                    // 传递参数查询参数
                    pageSize:       params.limit,
            ...
            responseHandler: function(res) {
                res=responseDecryptHandler(res);//解密
                if(res==null){
                    return { rows: [], total: 0 };
                }
            ...
            exportExcel: function(formId) {
                ...
                $.modal.confirm("确定导出所有" + table.options.modalName + "吗？", function() {
				    ...
				    let encrypJson = formFieldsToJsonEncryp(dataParam);
                    $.modal.loading("正在导出数据，请稍候...");
                    $.operate.postJson(table.options.exportUrl, encrypJson, function(result) {
            ...
            exportZip: function(formId) {
                ...
                $.modal.confirm("确定导出" + table.options.modalName + "吗？", function() {
				    ...
				    let encrypJson = formFieldsToJsonEncryp(dataParam);
                    $.modal.loading("正在导出数据，请稍候...");
                    $.operate.postJson(table.options.exportZipUrl, encrypJson, function(res) {
                        if (res.code == web_status.SUCCESS) {
                            window.location.href = ctx + "common/download2?fileName="+res.fileName+"&realFileName=" + res.realFileName + "&delete=true";
                        } else {
        ...
        treeTable: {
            ...
            responseHandler: function(res) {
                res=responseDecryptHandler(res);
        ...
        operate: {
            ...
            // 提交JSON数据
            submitJson: function(url, type, dataType, data, callback) {
                var config = {
                    url: url,
                    type: type,
                    dataType: dataType,
            ...
            postJson: function(url, data, callback) {
                $.operate.submitJson(url, "post", "json", data, callback);
            },
            // get请求传输
            ...
            remove: function(id) {
                ...
                $.modal.confirm("确定删除该条" + table.options.modalName + "信息吗？", function() {
                    ...
                    if (table.options.type == table_type.bootstrapTreeTable) {
                        ...
                        $.operate.submitJson(url, "delete", "json", data);
                    } else {
                        var data = { "ids":  id };
                        if (encryption == true || encryption == "true") {
                            data=encrypt1(data);
                        ...
                        $.operate.submitJson(url, "post", "json", data);
                    }
                });
            },
            // 批量删除信息
            ...
            saveModalJson: function(url, data, callback) {
                var config = {
                    url: url,
                    type: "post",
                    dataType: "json",
            ...
            successTabCallback: function(result) {
                if (result.code == web_status.SUCCESS) {
                    ...
                    var topWindow = $('.HuiTong_iframe[data-id="' + currentId + '"]', topWindow)[0];
