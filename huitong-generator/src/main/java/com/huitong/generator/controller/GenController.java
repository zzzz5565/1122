package com.huitong.generator.controller;
...
import com.huitong.common.core.domain.CxSelect;
...
import com.huitong.common.utils.security.PermissionUtils;
import com.huitong.common.utils.sql.SqlUtil;
import com.huitong.generator.domain.GenTable;
import com.huitong.generator.domain.GenTableColumn;
import com.huitong.generator.service.IGenTableColumnService;
import com.huitong.generator.service.IGenTableService;
...
public class GenController extends BaseController
{
    ...
    {
        startPage(genTable.getPageNum(),genTable.getPageSize());
    ...
    @Decrypt
    @Encrypt
    public TableDataInfo columnList(@RequestBody GenTableColumn genTableColumn)
    {
    ...
    @GetMapping("/download/{tableName}/{tableComment}")
    public void download(HttpServletResponse response, @PathVariable("tableName") String tableName, @PathVariable("tableComment") String tableComment) throws IOException
    {
        byte[] data = genTableService.downloadCode(tableName);
        genCode(response, data, tableComment);
    }
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"huitong.zip\"");
    ...
    private void genCode(HttpServletResponse response, byte[] data,String tableComment) throws IOException
    {
        response.reset();
        String fileName =new String((tableComment+".zip").getBytes("UTF-8"), "ISO-8859-1");
